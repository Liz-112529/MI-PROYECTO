...
#Función para calcular la temperatura por ciudad
def calcular_temperatura_promedio(temperaturas):
    """
    Calcular el promedio de temperaturas por ciudad.
    :param temperaturas: Lista de diccionarios con los datos de la temperaturas
    ...
    for temperatura in temperaturas:
        ...
        for semana in temperatura["semanas"]:  # Corrección aquí
            for dia in semana:
                total_temp += dia["temp"]
                total_dias += 1

        promedio_ciudad = total_temp / total_dias
        promedios[temperatura["ciudad"]] = round(promedio_ciudad, 2)  # Corrección aquí

    return promedios

# Llamar a la función y mostrar resultados en pantalla
